...
export const ProjectStastics = () => {
  const options = {
    ...
    useEffect(() => {
      if (chartRef.current && typeof ApexCharts !== "undefined"){
        const chart = new ApexCharts(chartRef.current, options); // Corregido
        chart.render();
        return () => {
          chart.destroy();
        };
  ...
  <div className=" w-full bg-white rounded-xl    p-4 md:p-6">
    <div className="flex justify-between">
      <div>
        <h5 className="leading-none text-3xl font-bold text-gray-900  pb-2">Estadistica de Proyectos</h5>
      </div>
      <div
